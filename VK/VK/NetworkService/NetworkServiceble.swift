...
final class NetworkServiceble: NetworkService {

    // MARK: - Public properties

    static let shared = NetworkServiceble()
    lazy var token: String? = nil
    ...
    private lazy var defaultQueryItems = [
        URLQueryItem(name: QueryItems.accessToken.rawValue, value: token ?? ""),
